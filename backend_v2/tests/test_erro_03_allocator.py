...
def test_next_erro_03_sequence_daily_reset(db_session):
    ...
    seq1 = next_erro_03_sequence(db_session, "1012665", "260911")
    assert seq1 == 1
    ...
    seq2 = next_erro_03_sequence(db_session, "1012665", "260911")
    assert seq2 == 2

    # Day 2: 260912 -> Sequence MUST RESET back to 1
    seq_day2 = next_erro_03_sequence(db_session, "1012665", "260912")
    assert seq_day2 == 1
